...
\item \emc{Dynamically typed}: While the program runs the types of objects are tracked, and operations are checked before being applied to ensure they are permitted. In contract \emc{statically typed} languages run this check before the program executes.
\end{itemize}
