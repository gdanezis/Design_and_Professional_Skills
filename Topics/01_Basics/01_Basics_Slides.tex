...
The Computer Science part of ENGS102P `Design and Professional Skills' course objectives:
\begin{itemize}
...
\begin{description}
	...
	\item[Maths.] Specialize the Newton-Raphson algorithm to compute the natural logarithm function $x = \ln v$. Note that the natural logarithm function represents the solution to the equation $e^x = v$.
	...
	\item[Test \& Measure.] What tests should to define for the natural logarithm function, and how many steps does your algorithm takes for different values of $v$.
