...
def task_build():
    """build cmd """
    return {
        'actions': ['pdflatex -shell-escape 01_Basics_Slides ;pdflatex -shell-escape 01_Basics_Slides ; bibtex 01_Basics_Slides ; pdflatex -shell-escape 01_Basics_Slides',],
        'file_dep': ["testreport.txt"] + Python_files +
                     ["01_Basics_Slides.tex"],
        'targets': ["01_Basics_Slides.pdf"],
        'verbosity': 2,
        }
